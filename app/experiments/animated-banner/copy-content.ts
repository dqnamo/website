export const BANNER_DEMO_INSTRUCTIONS = [
  {
    ...
    text: "Use an image-generation model like GPT Image 2. Ask for a wide cinematic banner image with the main subject weighted toward the right so the left side has room for text.",
  },
  {
    title: "Animate the still",
    text: "Send the still into an image-to-video model like Grok Imagine. Generate a short seamless clip, around three to five seconds, with subtle motion rather than a dramatic scene change.",
  },
  {
